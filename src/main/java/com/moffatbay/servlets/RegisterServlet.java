    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection(
                    "jdbc:mysql://localhost:3306/moffat_bay", "moffat", "password")) {  // I have to remove the underscore for it to work with mine - William, also be sure to enter your proper password
